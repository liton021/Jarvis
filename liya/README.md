...
A beautiful ChatGPT-like Flutter application for chatting with AI models. Features **Bring Your Own Key (BYOK)** architecture where users provide their own API keys stored securely on-device.
...
- 🤖 **Multiple Models** - Support for Gemini Flash, Pro, and experimental models
- 🏷️ **Custom Models** - Add your own model IDs (e.g., preview/experimental models)
...
- **No backend/server** - Direct client-to-AI communication
